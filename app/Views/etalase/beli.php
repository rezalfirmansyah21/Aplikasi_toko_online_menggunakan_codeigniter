...
<div class="container">
    <div class="row">
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <img class="rounded mx-auto d-block" width="300px" src="<?= base_url('uploads/' . $model->gambar) ?>">
        ...
        <div class="col-6">
            ...
            <div class="form-group">
                <label for="kabupaten">Pilih Kota/Kabupaten</label>
                <select class="form-control" id="kabupaten">
                    <option>Select Kota/Kabupaten</option>
                </select>
            </div>
            <div class="form-group">
                <label for="service">Pilih Servive</label>
    ...
    <a href="<?= site_url('etalase/index') ?>" class="btn btn-dark">Kembali</a>
    <br><br>
</div>
